...
#ifndef ZY_FPAY_VALIDACIONFACIAL_LIB_IOS_SWIFT_H
#define ZY_FPAY_VALIDACIONFACIAL_LIB_IOS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="zy_fpay_validacionfacial_lib_ios",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@interface SessionDelegate (SWIFT_EXTENSION(zy_fpay_validacionfacial_lib_ios)) <NSURLSessionDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(zy_fpay_validacionfacial_lib_ios)) <NSURLSessionDataDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(zy_fpay_validacionfacial_lib_ios)) <NSURLSessionDownloadDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(zy_fpay_validacionfacial_lib_ios)) <NSURLSessionTaskDelegate>
