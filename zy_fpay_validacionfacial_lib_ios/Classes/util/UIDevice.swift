...
//  zy-onefinger-ios
//
//  Created by Developer on 8/19/20.
...
extension UIDevice {
    ...
    var type: Model {
        ...
        let modelMap : [String: Model] = [
            ...
            "Watch6,10" : .AppleWatchSEGPS40,
            "Watch6,11" : .AppleWatchSEGPS44,
            "Watch6,12" : .AppleWatchSEGPSCELL40,
            "Watch6,13" : .AppleWatchSEGPSCELL44,
            "Watch6,14" : .AppleWatchS8GPS40,
            "Watch6,15" : .AppleWatchS8GPS44,
            "Watch6,16" : .AppleWatchS8GPSCELL40,
            "Watch6,17" : .AppleWatchS8GPSCELL44,
...
public enum Model : String {
    ...
    case simulator     = "simulator/sandbox",
         ...
         AppleWatchSEGPS40        = "Apple Watch SE 40mm case (GPS)",
         AppleWatchSEGPS44        = "Apple Watch SE 44mm case (GPS)",
         AppleWatchSEGPSCELL40        = "Apple Watch SE 40mm case (GPS+Cellular)",
         AppleWatchSEGPSCELL44        = "Apple Watch SE 440mm case (GPS+Cellular)",
         AppleWatchS8GPS40        = "Apple Watch S8 40mm case (GPS)",
         AppleWatchS8GPS44        = "Apple Watch S8 44mm case (GPS)",
         AppleWatchS8GPSCELL40        = "Apple Watch S8 40mm case (GPS+Cellular)",
         AppleWatchS8GPSCELL44        = "Apple Watch S8 440mm case (GPS+Cellular)",
...
extension UIAlertController {
    ...
    func presentInOwnWindow(animated: Bool, vc:ViewController, completion: (() -> Void)?) {
        let alertWindow = UIWindow(frame: UIScreen.main.bounds)
        alertWindow.rootViewController = UIViewController()
        alertWindow.windowLevel = UIWindow.Level.alert + 1;
        alertWindow.makeKeyAndVisible()
        alertWindow.rootViewController?.present(vc, animated: animated, completion: completion)
    }
}
